...
./main.py -c 1 -r 0.5 -k 3 -m 0.02 ../tsplib/u1060.tsp -t1 1 -t2 1 -t3 1 -F False -g 1000 -n 30 -o ../results4/TTT

./main.py -c 1 -r 0.5 -k 3 -m 0.02 ../tsplib/u1060.tsp -t1 1 -t2 1 -t3 1 -E False -F False -g 1000 -n 30 -o ../results4/TTTe
